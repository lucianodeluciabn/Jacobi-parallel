...
/* jacobi.0.6.c .							     */
/*							                     */
/* - ottimizzazione della versione 0.5 nel prodotto matrice-vettore.	     */
/*   eliminato il confronto "i!=j" ad ogni iterazione splittando il loop     */
/*   originario in due loop che evitano il caso "i==j".                      */
/*                                                                           */
/* - aumentata la tolleranza 	                                             */
/*****************************************************************************/
...
int main(int argc, char *argv[])
{
	...
	const double TOL_QUAD=1e-8; //tolleranza

	/******************************/
	/*  allocazione vettori CSR   */
	/******************************/
	//le = vettore degli elementi no nulli di A[N][N] (ordinati per riga)
