/*****************************************************************************/
/* jacobi.0.7.c parallelo						     */
/*    rispetto alla versione precedente adesso viene inviato                 */
/*    anche il vettore b (diviso per ciascun worker) ed è stata apporata     */
/*    una prima ottimizzazione alla comunicazione in modo da sfruttare       */
/*    meglio il parallelismo					             */
/*****************************************************************************/
...
int main(int argc, char *argv[])
{
	...
	{	
		...
		b_coord=(double*)malloc(A_coord.n_row*sizeof(double));

		//allocazione vettori x(k) e x(k+1)
		x_k_1=(double*)malloc(A_coord.n_row*sizeof(double));
