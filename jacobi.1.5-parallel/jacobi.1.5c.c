/***************************************************************************************/
/*  jacobi.1.5c.c parallelo: MPI + OMP - (GATHER + BROADCAST - SENZA GESTIONE HOTSPOT) */
/*  					     			             	       */
/***************************************************************************************/
...
int main(int argc, char *argv[])
{
	...
	{	
		...
		#pragma omp parallel shared(A_gen, b_gen, x_k, x_k_1, x_tmp, job_worker, rank, e_num, e_den) private(k, i, aii, x_k_1_quad) firstprivate(iter)
		{
			do
			{
